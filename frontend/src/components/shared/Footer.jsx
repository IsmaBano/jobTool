...
function Footer() {
  return (
    <div className='text-center shadow-lg pb-3 border-t border-gray-200'>
         <div className="mb-4 mt-4 ">
            <h2 className="text-xl mb-2 font-bold">Job Tool</h2>
            <p className="text-sm">© 2024 Company. All rights reserved.</p>
          </div>
          
       <div className='flex justify-center gap-4 mt-3'>
       <div><a href="https://facebook.com" className="hover:text-gray-400" aria-label="Facebook">
           ...
           <div> <a href="https://twitter.com" className="hover:text-gray-400" aria-label="Twitter">
           ...
           <div> <a href="https://linkedin.com" className="hover:text-gray-400" aria-label="LinkedIn">
